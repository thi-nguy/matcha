...
const dataListBenefit = [
  ...
  },
  {
    ...
    subtitle: 'Unlike most web dating website, your public fame rating is visible so you can work on it'
  }
]
  ...
  return (
    <div className='md:flex h-screen'>
      ...
      <div className='md:w-6/12 justify-center flex flex-col p-20'>
        ...
        <TextInput title='Firstname' placeholder='John' value={firstname} onChange={setFirstname}/>
        <TextInput title='Lastname' placeholder='Doe' value={lastname} onChange={setLastname}/>
